import{t as G,c as Q,O as W,M as Y,B as j,F as D,S as d,U as _,V as h,W as b,H as x,N as K,C as X,a as u,b as v,A as $,d as q,R as J,e as Z,f as ee,L as te,g as se,h as ie,i as ae,j as oe,k as re,r as B,s as le,l as P,P as R,m as y,n as ne,o as N,p as E,q as O,u as c,v as T,w as I,x as he,y as ue,z as fe,D as k,E as ce}from"./3d-DH_mg1Kz.js";const C=[1,2,4,8];class de{hits=0;fails=0;combo=0;maxCombo=0;score=0;onChange;constructor(){this._updateText()}onFail(){this.fails++,this.combo=0,this._updateText(),this.onChange?.()}onSuccess(){this.hits++,this.combo++,this.combo>this.maxCombo&&(this.maxCombo=this.combo),this.score+=this.combo>C.length-1?C[C.length-1]:C[this.combo],this._updateText(),this.onChange?.()}_updateText(){G.geometry=Q(`   Score: ${this.score}
   Combo: ${this.combo}
   Hits: ${this.hits}
