...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:on,depthTest:!1,depthWrite:!1})}function yo(){return new me({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Aa(),fragmentShader:`
		...
		`,blending:on,depthTest:!1,depthWrite:!1})}function Eo(){return new me({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Aa(),fragmentShader:`
	...
	`}function pd(i){let t=new WeakMap,e=null;function n(o){if(o&&o.isTexture){const l=o.mapping,c=l===Us||l===Ns,h=l===ui||l===fi;if(c||h){let u=t.get(o);const f=u!==void 0?u.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==f)return e===null&&(e=new Mo(i)),u=c?e.fromEquirectangular(o,u):e.fromCubemap(o,u),u.texture.pmremVersion=o.pmremVersion,t.set(o,u),u.texture;if(u!==void 0)return u.texture;{const m=o.image;return c&&m&&m.height>0||h&&m&&r(m)?(e===null&&(e=new Mo(i)),u=c?e.fromEquirectangular(o):e.fromCubemap(o),u.texture.pmremVersion=o.pmremVersion,t.set(o,u),o.addEventListener("dispose",s),u.texture):null}}}return o}function r(o){let l=0;const c=6;for(let h=0;h<c;h++)o[h]!==void 0&&l++;return l===c}function s(o){const l=o.target;l.removeEventListener("dispose",s);const c=t.get(l);c!==void 0&&(t.delete(l),c.dispose())}function a(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:a}}function md(i){const t={};function e(n){if(t[n]!==void 0)return t[n];let r;switch(n){case"WEBGL_depth_texture":r=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=i.getExtension(n)}return t[n]=r,r}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){const r=e(n);return r===null&&Ii("THREE.WebGLRenderer: "+n+" extension not supported."),r}}}function gd(i,t,e,n){const r={},s=new WeakMap;function a(u){const f=u.target;f.index!==null&&t.remove(f.index);for(const g in f.attributes)t.remove(f.attributes[g]);for(const g in f.morphAttributes){const v=f.morphAttributes[g];for(let p=0,d=v.length;p<d;p++)t.remove(v[p])}f.removeEventListener("dispose",a),delete r[f.id];const m=s.get(f);m&&(t.remove(m),s.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,e.memory.geometries--}function o(u,f){return r[f.id]===!0||(f.addEventListener("dispose",a),r[f.id]=!0,e.memory.geometries++),f}function l(u){const f=u.attributes;for(const g in f)t.update(f[g],i.ARRAY_BUFFER);const m=u.morphAttributes;for(const g in m){const v=m[g];for(let p=0,d=v.length;p<d;p++)t.update(v[p],i.ARRAY_BUFFER)}}function c(u){const f=[],m=u.index,g=u.attributes.position;let v=0;if(m!==null){const T=m.array;v=m.version;for(let x=0,E=T.length;x<E;x+=3){const O=T[x+0],A=T[x+1],C=T[x+2];f.push(O,A,A,C,C,O)}}else if(g!==void 0){const T=g.array;v=g.version;for(let x=0,E=T.length/3-1;x<E;x+=3){const O=x+0,A=x+1,C=x+2;f.push(O,A,A,C,C,O)}}else return;const p=new(Al(f)?Dl:Ll)(f,1);p.version=v;const d=s.get(u);d&&t.remove(d),s.set(u,p)}function h(u){const f=s.get(u);if(f){const m=u.index;m!==null&&f.version<m.version&&c(u)}else c(u);return s.get(u)}return{get:o,update:l,getWireframeAttribute:h}}function _d(i,t,e){let n;function r(f){n=f}let s,a;function o(f){s=f.type,a=f.bytesPerElement}function l(f,m){i.drawElements(n,m,s,f*a),e.update(m,n,1)}function c(f,m,g){g!==0&&(i.drawElementsInstanced(n,m,s,f*a,g),e.update(m,n,g))}function h(f,m,g){if(g===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,m,0,s,f,0,g);let p=0;for(let d=0;d<g;d++)p+=m[d];e.update(p,n,1)}function u(f,m,g,v){if(g===0)return;const p=t.get("WEBGL_multi_draw");if(p===null)for(let d=0;d<f.length;d++)c(f[d]/a,m[d],v[d]);else{p.multiDrawElementsInstancedWEBGL(n,m,0,s,f,0,v,0,g);let d=0;for(let T=0;T<g;T++)d+=m[T];for(let T=0;T<v.length;T++)e.update(d,n,v[T])}}this.setMode=r,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function vd(i){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,a,o){switch(e.calls++,a){case i.TRIANGLES:e.triangles+=o*(s/3);break;case i.LINES:e.lines+=o*(s/2);break;case i.LINE_STRIP:e.lines+=o*(s-1);break;case i.LINE_LOOP:e.lines+=o*s;break;case i.POINTS:e.points+=o*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function r(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:r,update:n}}function xd(i,t,e){const n=new WeakMap,r=new Kt;function s(a,o,l){const c=a.morphTargetInfluences,h=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,u=h!==void 0?h.length:0;let f=n.get(o);if(f===void 0||f.count!==u){let y=function(){C.dispose(),n.delete(o),o.removeEventListener("dispose",y)};f!==void 0&&f.texture.dispose();const m=o.morphAttributes.position!==void 0,g=o.morphAttributes.normal!==void 0,v=o.morphAttributes.color!==void 0,p=o.morphAttributes.position||[],d=o.morphAttributes.normal||[],T=o.morphAttributes.color||[];let x=0;m===!0&&(x=1),g===!0&&(x=2),v===!0&&(x=3);let E=o.attributes.position.count*x,O=1;E>t.maxTextureSize&&(O=Math.ceil(E/t.maxTextureSize),E=t.maxTextureSize);const A=new Float32Array(E*O*4*u),C=new Cl(A,E,O,u);C.type=sn,C.needsUpdate=!0;const U=x*4;for(let S=0;S<u;S++){const P=p[S],W=d[S],z=T[S],k=E*O*4*S;for(let K=0;K<P.count;K++){const V=K*U;m===!0&&(r.fromBufferAttribute(P,K),A[k+V+0]=r.x,A[k+V+1]=r.y,A[k+V+2]=r.z,A[k+V+3]=0),g===!0&&(r.fromBufferAttribute(W,K),A[k+V+4]=r.x,A[k+V+5]=r.y,A[k+V+6]=r.z,A[k+V+7]=0),v===!0&&(r.fromBufferAttribute(z,K),A[k+V+8]=r.x,A[k+V+9]=r.y,A[k+V+10]=r.z,A[k+V+11]=z.itemSize===4?r.w:1)}}f={count:u,texture:C,size:new st(E,O)},n.set(o,f),o.addEventListener("dispose",y)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",a.morphTexture,e);else{let m=0;for(let v=0;v<c.length;v++)m+=c[v];const g=o.morphTargetsRelative?1:1-m;l.getUniforms().setValue(i,"morphTargetBaseInfluence",g),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",f.texture,e),l.getUniforms().setValue(i,"morphTargetsTextureSize",f.size)}return{update:s}}function Md(i,t,e,n){let r=new WeakMap;function s(l){const c=n.render.frame,h=l.geometry,u=t.get(l,h);if(r.get(u)!==c&&(t.update(u),r.set(u,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),r.get(l)!==c&&(e.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&e.update(l.instanceColor,i.ARRAY_BUFFER),r.set(l,c))),l.isSkinnedMesh){const f=l.skeleton;r.get(f)!==c&&(f.update(),r.set(f,c))}return u}function a(){r=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),e.remove(c.instanceMatrix),c.instanceColor!==null&&e.remove(c.instanceColor)}return{update:s,dispose:a}}class Bl extends xe{constructor(t,e,n,r,s,a,o,l,c,h=li){if(h!==li&&h!==pi)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&h===li&&(n=zn),n===void 0&&h===pi&&(n=di),super(null,r,s,a,o,l,h,n,c),this.isDepthTexture=!0,this.image={width:t,height:e},this.magFilter=o!==void 0?o:Le,this.minFilter=l!==void 0?l:Le,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(t){return super.copy(t),this.compareFunction=t.compareFunction,this}toJSON(t){const e=super.toJSON(t);return this.compareFunction!==null&&(e.compareFunction=this.compareFunction),e}}const zl=new xe,To=new Bl(1,1),Hl=new Cl,Vl=new sh,Gl=new Nl,bo=[],Ao=[],wo=new Float32Array(16),Co=new Float32Array(9),Ro=new Float32Array(4);function yi(i,t,e){const n=i[0];if(n<=0||n>0)return i;const r=t*e;let s=bo[r];if(s===void 0&&(s=new Float32Array(r),bo[r]=s),t!==0){n.toArray(s,0);for(let a=1,o=0;a!==t;++a)o+=e,i[a].toArray(s,o)}return s}function ae(i,t){if(i.length!==t.length)return!1;for(let e=0,n=i.length;e<n;e++)if(i[e]!==t[e])return!1;return!0}function oe(i,t){for(let e=0,n=t.length;e<n;e++)i[e]=t[e]}function kr(i,t){let e=Ao[t];e===void 0&&(e=new Int32Array(t),Ao[t]=e);for(let n=0;n!==t;++n)e[n]=i.allocateTextureUnit();return e}function Sd(i,t){const e=this.cache;e[0]!==t&&(i.uniform1f(this.addr,t),e[0]=t)}function yd(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ae(e,t))return;i.uniform2fv(this.addr,t),oe(e,t)}}function Ed(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(i.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(ae(e,t))return;i.uniform3fv(this.addr,t),oe(e,t)}}function Td(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ae(e,t))return;i.uniform4fv(this.addr,t),oe(e,t)}}function bd(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(ae(e,t))return;i.uniformMatrix2fv(this.addr,!1,t),oe(e,t)}else{if(ae(e,n))return;Ro.set(n),i.uniformMatrix2fv(this.addr,!1,Ro),oe(e,n)}}function Ad(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(ae(e,t))return;i.uniformMatrix3fv(this.addr,!1,t),oe(e,t)}else{if(ae(e,n))return;Co.set(n),i.uniformMatrix3fv(this.addr,!1,Co),oe(e,n)}}function wd(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(ae(e,t))return;i.uniformMatrix4fv(this.addr,!1,t),oe(e,t)}else{if(ae(e,n))return;wo.set(n),i.uniformMatrix4fv(this.addr,!1,wo),oe(e,n)}}function Cd(i,t){const e=this.cache;e[0]!==t&&(i.uniform1i(this.addr,t),e[0]=t)}function Rd(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ae(e,t))return;i.uniform2iv(this.addr,t),oe(e,t)}}function Pd(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(ae(e,t))return;i.uniform3iv(this.addr,t),oe(e,t)}}function Ld(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ae(e,t))return;i.uniform4iv(this.addr,t),oe(e,t)}}function Dd(i,t){const e=this.cache;e[0]!==t&&(i.uniform1ui(this.addr,t),e[0]=t)}function Id(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ae(e,t))return;i.uniform2uiv(this.addr,t),oe(e,t)}}function Ud(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(ae(e,t))return;i.uniform3uiv(this.addr,t),oe(e,t)}}function Nd(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ae(e,t))return;i.uniform4uiv(this.addr,t),oe(e,t)}}function Fd(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);let s;this.type===i.SAMPLER_2D_SHADOW?(To.compareFunction=bl,s=To):s=zl,e.setTexture2D(t||s,r)}function Od(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),e.setTexture3D(t||Vl,r)}function Bd(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),e.setTextureCube(t||Gl,r)}function zd(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),e.setTexture2DArray(t||Hl,r)}function Hd(i){switch(i){case 5126:return Sd;case 35664:return yd;case 35665:return Ed;case 35666:return Td;case 35674:return bd;case 35675:return Ad;case 35676:return wd;case 5124:case 35670:return Cd;case 35667:case 35671:return Rd;case 35668:case 35672:return Pd;case 35669:case 35673:return Ld;case 5125:return Dd;case 36294:return Id;case 36295:return Ud;case 36296:return Nd;case 35678:case 36198:case 36298:case 36306:case 35682:return Fd;case 35679:case 36299:case 36307:return Od;case 35680:case 36300:case 36308:case 36293:return Bd;case 36289:case 36303:case 36311:case 36292:return zd}}function Vd(i,t){i.uniform1fv(this.addr,t)}function Gd(i,t){const e=yi(t,this.size,2);i.uniform2fv(this.addr,e)}function kd(i,t){const e=yi(t,this.size,3);i.uniform3fv(this.addr,e)}function Wd(i,t){const e=yi(t,this.size,4);i.uniform4fv(this.addr,e)}function Xd(i,t){const e=yi(t,this.size,4);i.uniformMatrix2fv(this.addr,!1,e)}function qd(i,t){const e=yi(t,this.size,9);i.uniformMatrix3fv(this.addr,!1,e)}function Yd(i,t){const e=yi(t,this.size,16);i.uniformMatrix4fv(this.addr,!1,e)}function Kd(i,t){i.uniform1iv(this.addr,t)}function Zd(i,t){i.uniform2iv(this.addr,t)}function $d(i,t){i.uniform3iv(this.addr,t)}function Jd(i,t){i.uniform4iv(this.addr,t)}function jd(i,t){i.uniform1uiv(this.addr,t)}function Qd(i,t){i.uniform2uiv(this.addr,t)}function tp(i,t){i.uniform3uiv(this.addr,t)}function ep(i,t){i.uniform4uiv(this.addr,t)}function np(i,t,e){const n=this.cache,r=t.length,s=kr(e,r);ae(n,s)||(i.uniform1iv(this.addr,s),oe(n,s));for(let a=0;a!==r;++a)e.setTexture2D(t[a]||zl,s[a])}function ip(i,t,e){const n=this.cache,r=t.length,s=kr(e,r);ae(n,s)||(i.uniform1iv(this.addr,s),oe(n,s));for(let a=0;a!==r;++a)e.setTexture3D(t[a]||Vl,s[a])}function rp(i,t,e){const n=this.cache,r=t.length,s=kr(e,r);ae(n,s)||(i.uniform1iv(this.addr,s),oe(n,s));for(let a=0;a!==r;++a)e.setTextureCube(t[a]||Gl,s[a])}function sp(i,t,e){const n=this.cache,r=t.length,s=kr(e,r);ae(n,s)||(i.uniform1iv(this.addr,s),oe(n,s));for(let a=0;a!==r;++a)e.setTexture2DArray(t[a]||Hl,s[a])}function ap(i){switch(i){case 5126:return Vd;case 35664:return Gd;case 35665:return kd;case 35666:return Wd;case 35674:return Xd;case 35675:return qd;case 35676:return Yd;case 5124:case 35670:return Kd;case 35667:case 35671:return Zd;case 35668:case 35672:return $d;case 35669:case 35673:return Jd;case 5125:return jd;case 36294:return Qd;case 36295:return tp;case 36296:return ep;case 35678:case 36198:case 36298:case 36306:case 35682:return np;case 35679:case 36299:case 36307:return ip;case 35680:case 36300:case 36308:case 36293:return rp;case 36289:case 36303:case 36311:case 36292:return sp}}class op{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=Hd(e.type)}}class lp{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=ap(e.type)}}class cp{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const r=this.seq;for(let s=0,a=r.length;s!==a;++s){const o=r[s];o.setValue(t,e[o.id],n)}}}const ys=/(\w+)(\])?(\[|\.)?/g;function Po(i,t){i.seq.push(t),i.map[t.id]=t}function hp(i,t,e){const n=i.name,r=n.length;for(ys.lastIndex=0;;){const s=ys.exec(n),a=ys.lastIndex;let o=s[1];const l=s[2]==="]",c=s[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===r){Po(e,c===void 0?new op(o,i,t):new lp(o,i,t));break}else{let u=e.map[o];u===void 0&&(u=new cp(o),Po(e,u)),e=u}}}class Cr{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const s=t.getActiveUniform(e,r),a=t.getUniformLocation(e,s.name);hp(s,a,this)}}setValue(t,e,n,r){const s=this.map[e];s!==void 0&&s.setValue(t,n,r)}setOptional(t,e,n){const r=e[n];r!==void 0&&this.setValue(t,n,r)}static upload(t,e,n,r){for(let s=0,a=e.length;s!==a;++s){const o=e[s],l=n[o.id];l.needsUpdate!==!1&&o.setValue(t,l.value,r)}}static seqWithValue(t,e){const n=[];for(let r=0,s=t.length;r!==s;++r){const a=t[r];a.id in e&&n.push(a)}return n}}function Lo(i,t,e){const n=i.createShader(t);return i.shaderSource(n,e),i.compileShader(n),n}const up=37297;let fp=0;function dp(i,t){const e=i.split(`
`),n=[],r=Math.max(t-6,0),s=Math.min(t+6,e.length);for(let a=r;a<s;a++){const o=a+1;n.push(`${o===t?">":" "} ${o}: ${e[a]}`)}return n.join(`
`)}function pp(i){const t=zt.getPrimaries(zt.workingColorSpace),e=zt.getPrimaries(i);let n;switch(t===e?n="":t===Ur&&e===Ir?n="LinearDisplayP3ToLinearSRGB":t===Ir&&e===Ur&&(n="LinearSRGBToLinearDisplayP3"),i){case Tn:case Vr:return[n,"LinearTransferOETF"];case Ge:case Ea:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function Do(i,t,e){const n=i.getShaderParameter(t,i.COMPILE_STATUS),r=i.getShaderInfoLog(t).trim();if(n&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const a=parseInt(s[1]);return e.toUpperCase()+`

`+r+`

`+dp(i.getShaderSource(t),a)}else return r}function mp(i,t){const e=pp(t);return`vec4 ${i}( vec4 value ) { return ${e[0]}( ${e[1]}( value ) ); }`}function gp(i,t){let e;switch(t){case ol:e="Linear";break;case ll:e="Reinhard";break;case cl:e="OptimizedCineon";break;case hl:e="ACESFilmic";break;case ul:e="AgX";break;case fl:e="Neutral";break;case zc:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const pr=new R;function _p(){zt.getLuminanceCoefficients(pr);const i=pr.x.toFixed(4),t=pr.y.toFixed(4),e=pr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),t}function Ap(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===sl?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===uc?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===nn&&(t="SHADOWMAP_TYPE_VSM"),t}function wp(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case ui:case fi:t="ENVMAP_TYPE_CUBE";break;case Hr:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Cp(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case fi:t="ENVMAP_MODE_REFRACTION";break}return t}function Rp(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case al:t="ENVMAP_BLENDING_MULTIPLY";break;case Oc:t="ENVMAP_BLENDING_MIX";break;case Bc:t="ENVMAP_BLENDING_ADD";break}return t}function Pp(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function Lp(i,t,e,n){const r=i.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=Ap(e),c=wp(e),h=Cp(e),u=Rp(e),f=Pp(e),m=vp(e),g=xp(s),v=r.createProgram();let p,d,T=e.glslVersion?"#version "+e.glslVersion+`
...
`,Sn={iTime:{value:0},iVisibility:{value:0},iResolution:{value:new R(window.innerWidth,window.innerHeight,1)},colorLeft:{value:new R(0,0,0)},colorRight:{value:new R(0,0,0)},colorCenter1:{value:new R(0,0,0)},colorCenter2:{value:new R(0,0,0)},colorCenter3:{value:new R(0,0,0)}},rg=new Si(2,2),$l=new me({vertexShader:ng,fragmentShader:ig,uniforms:Sn});$l.depthWrite=!1;const sg=new ce(rg,$l);function Or(i,t,e,n,r){const s=e-t,a=r-n;return(i-t)/s*a+n}function Ia(i,t,e){return i+(t-i)*e}function ag(i,t){let e=1/0,n=-1;return i.forEach((r,s)=>{const a=t(r);a<e&&(e=a,n=s)}),i[n]}const Br=100,Xr=0,gi=[-1.8,-.6,.6,1.8],Ce=new hm;Ce.fog=new wa(16689918,.003);const Ei=new cm({antialias:!0});Ei.setPixelRatio(window.devicePixelRatio);Ei.setSize(window.innerWidth,window.innerHeight);document.body.appendChild(Ei.domElement);const Vi=new we(30,window.innerWidth/window.innerHeight,.1,600);Vi.position.set(0,5,12);Vi.rotation.x=Math.PI*-.1;const xr=(i,t)=>{const e=new Da(i,100,500);return e.position.set(0,10,-10*t),Ce.add(e),e},og=[xr(15606510,2),xr(15615214,5),xr(15623918,7),xr(15632622,9)],Mr=i=>{const t=new Da(0,0,50);return t.position.set(gi[i],1,Xr+.5),Ce.add(t),t},Rs=[Mr(0),Mr(1),Mr(2),Mr(3)],xn=(i,t,e)=>{const n=new Da(0,0,5e3);return n.position.set(Or(i,-.5,.5,gi[1],gi[2]),t*3,-10*e),Ce.add(n),n},be={center1:xn(0,5,1),center2:xn(0,5,3),left:xn(5,1,3),right:xn(-5,1,3),center3:xn(0,5,5),hz1:xn(-1,0,0),hz2:xn(0,0,0),hz3:xn(1,0,0)},Ps=[be.center1,be.center2,be.left,be.right,be.center3,be.hz1,be.hz2,be.hz3],lg=new Si(5,1e3),cg=new Bn({color:328976}),Jl=new ce(lg,cg);Jl.rotation.x=-Math.PI/2;Ce.add(Jl);const hg=new hn(5,1,.1),ug=new Bn({color:16776977,emissive:16776977,emissiveIntensity:.4}),Ua=new ce(hg,ug);Ua.position.set(0,-.4,-Xr);Ce.add(Ua);const fg=new hn(1,.1,1e3),dg=new Bn({color:657944}),pg=i=>{const t=new ce(fg,dg);t.position.x=gi[i],Ce.add(t)};for(let i=0;i<4;i++)pg(i);const mg=[-2.3,-1.2,0,1.2,2.3],Jo=[5300963,15820012,5300963,15820012,5300963],gg=new hn(.04,.02,1e3);mg.forEach((i,t)=>{const e=new Bn({color:Jo[t],emissive:Jo[t],emissiveIntensity:1.7}),n=new ce(gg,e);n.position.set(i,.06,0),Ce.add(n)});const jl=[],Pr={NEUTRAL:new Bn({color:8949936,emissive:3364351,emissiveIntensity:.3}),SUCCESS:new Bn({color:2777136,emissive:2293589,emissiveIntensity:.9}),FAILED:new Bn({color:9449520,emissive:16716083,emissiveIntensity:1.6})},_g=new hn(1,.6,1),vg=()=>{const i=new ce(_g,Pr.NEUTRAL);i.position.z=Br,jl.push(i),Ce.add(i)};for(let i=0;i<100;i++)vg();const xg=new jm,Mg="https://raw.githubusercontent.com/mrdoob/three.js/master/examples/fonts/helvetiker_regular.typeface.json",Sg=await new Promise((i,t)=>{xg.load(Mg,i,void 0,t)}),Na=(i,t=.5)=>{const e=Sg.generateShapes(i,t),n=new Pa(e);n.computeBoundingBox();const r=-.5*(n.boundingBox.max.x-n.boundingBox.min.x);return n.translate(r,0,0),n},Ql=new Gr({color:16777215}),Fa=new ce(Na(`   Score: 0
   Combo: 0
   Hits: 0
   Fails: 0`),Ql);Fa.position.set(-5,2,-15);Ce.add(Fa);function Sr(i,t){const e=new ce(Na(t,.3),Ql);return e.position.set(gi[i],.1,4),e.rotation.x=-Math.PI/2,Ce.add(e),e}Sr(0,"S"),Sr(1,"D"),Sr(2,"K"),Sr(3,"L");Ce.add(sg);const yr=[1,2,4,8];class yg{hits=0;fails=0;combo=0;maxCombo=0;score=0;onFail(){this.fails++,this.combo=0,this._updateText()}onSuccess(){this.hits++,this.combo++,this.combo>this.maxCombo&&(this.maxCombo=this.combo),this.score+=this.combo>yr.length-1?yr[yr.length-1]:yr[this.combo],this._updateText()}_updateText(){Fa.geometry=Na(`   Score: ${this.score}
   Combo: ${this.combo}
   Hits: ${this.hits}
   Fails: ${this.fails}`)}}const tc={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}_i.BlurDirectionX=new st(1,0);_i.BlurDirectionY=new st(0,1);const Lg={name:"OutputShader",uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		...
		}`};class Dg extends Ti{constructor(){super();const t=Lg;this.uniforms=Oi.clone(t.uniforms),this.material=new Gm({name:t.name,uniforms:this.uniforms,vertexShader:t.vertexShader,fragmentShader:t.fragmentShader}),this.fsQuad=new Oa(this.material),this._outputColorSpace=null,this._toneMapping=null}render(t,e,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=t.toneMappingExposure,(this._outputColorSpace!==t.outputColorSpace||this._toneMapping!==t.toneMapping)&&(this._outputColorSpace=t.outputColorSpace,this._toneMapping=t.toneMapping,this.material.defines={},zt.getTransfer(this._outputColorSpace)===Yt&&(this.material.defines.SRGB_TRANSFER=""),this._toneMapping===ol?this.material.defines.LINEAR_TONE_MAPPING="":this._toneMapping===ll?this.material.defines.REINHARD_TONE_MAPPING="":this._toneMapping===cl?this.material.defines.CINEON_TONE_MAPPING="":this._toneMapping===hl?this.material.defines.ACES_FILMIC_TONE_MAPPING="":this._toneMapping===ul?this.material.defines.AGX_TONE_MAPPING="":this._toneMapping===fl&&(this.material.defines.NEUTRAL_TONE_MAPPING=""),this.material.needsUpdate=!0),this.renderToScreen===!0?(t.setRenderTarget(null),this.fsQuad.render(t)):(t.setRenderTarget(e),this.clear&&t.clear(t.autoClearColor,t.autoClearDepth,t.autoClearStencil),this.fsQuad.render(t))}dispose(){this.material.dispose(),this.fsQuad.dispose()}}const Ig=.2,Ug=.1,Ng=1.5,Fg=4,ma=Ei.getPixelRatio(),Og=new De(window.innerWidth*ma,window.innerHeight*ma,{samples:Fg,type:Xe}),Bg=new st(window.innerWidth,window.innerHeight),zg=new _i(Bg,Ig,Ug,Ng),vi=new Cg(Ei,Og);vi.setPixelRatio(ma);vi.addPass(new Rg(Ce,Vi));vi.addPass(zg);vi.addPass(new Dg);class Hg{constructor(t,e){this.game=t,this.cubesVisuals=new Vg(this),this.backgroundVisuals=new Wg(this),this.finishVisuals=new kg(this),this.lightsVisuals=new Gg(this,e)}lightsVisuals;cubesVisuals;backgroundVisuals;finishVisuals;update(t){this.cubesVisuals.update(),this.finishVisuals.update(),this.lightsVisuals.update(),this.backgroundVisuals.update(t),vi.render()}timeNow(){return this.game.timeNow}resize(){Vi.aspect=window.innerWidth/window.innerHeight,Vi.updateProjectionMatrix(),Ei.setSize(window.innerWidth,window.innerHeight),vi.setSize(window.innerWidth,window.innerHeight)}}class Vg{constructor(t){this.visuals=t}update(){const t=this.visuals.game,e=t.notes.getDisplayNotes();for(let n=0;n<100;n++){const r=jl[n],s=e[n];if(!s){r.position.z=Br;continue}let a=Or(s.time,t.timeNow,t.notes.timeTop,0,1);a=Math.pow(a,3)+a,r.position.z=-Or(a,0,1,Xr,Br),r.position.x=gi[s.note],r.material=this._getCubeMaterial(s)}}_getCubeMaterial(t){if(t.status==null)return Pr.NEUTRAL;if(t.status)return Pr.SUCCESS;if(!t.status)return Pr.FAILED;throw new Error("Invalid note status")}}class Gg{constructor(t,e){this.visuals=t,this.lightEvents=e,this.lightsTarget=Ps.map(()=>0)}COLORS=[new wt(65536),new wt(5300963),new wt(15820012),new wt(16777215)];INTENSITY=500;lightEventIndex=0;lightsTarget;update(){Ps.forEach((n,r)=>{n.intensity=Ia(n.intensity,this.lightsTarget[r],.2)}),this.setBackgroundColor(Sn.colorLeft,be.left),this.setBackgroundColor(Sn.colorRight,be.right),this.setBackgroundColor(Sn.colorCenter1,be.center1),this.setBackgroundColor(Sn.colorCenter2,be.center2),this.setBackgroundColor(Sn.colorCenter3,be.center3);const t=this.lightEvents[this.lightEventIndex];if(!t)return;t.time-this.visuals.timeNow()<=0&&(this.lightEventIndex++,this.lightEffect(t))}lightEffect(t){const e=Ps[t.lightIndex];if(!e){console.error("Invalid light index",t.lightIndex);return}const n=this.COLORS[t.colorI];if(!n){console.error("Invalid color index",t.colorI);return}e.color=n,t.modeI==1?e.intensity=this.INTENSITY:(t.modeI==2||t.modeI==3)&&(e.intensity=this.INTENSITY*2),t.modeI==3?this.lightsTarget[t.lightIndex]=0:this.lightsTarget[t.lightIndex]=this.INTENSITY}setBackgroundColor(t,e){const n=Math.min(1,e.intensity/this.INTENSITY);t.value.set(e.color.r*n,e.color.g*n,e.color.b*n)}}class kg{constructor(t){this.visuals=t}COLOR_RED=new wt(16711680);COLOR_GREEN=new wt(65280);failFlashElem=document.getElementById("failFlash");update(){Rs.forEach(t=>t.intensity=Ia(t.intensity,0,.06))}onHitOrMiss(t,e){Rs[e].intensity=150,Rs[e].color=t?this.COLOR_GREEN:this.COLOR_RED,t||this.flashFail(),this.visuals.backgroundVisuals.onNotePlay()}flashFail(){this.failFlashElem&&this.failFlashElem.animate([{opacity:.9},{opacity:0}],{duration:280,easing:"ease-out"})}setFinishSize(t,e){const n=Or(t,0,e,Xr,Br);Ua.scale.z=n}}class Wg{constructor(t){this.visuals=t}lightsIntensity=0;backgroundTime=0;update(t){const e=this.visuals.timeNow();this.backgroundTime+=t+.001,this.lightsIntensity=Ia(this.lightsIntensity,.5,.01),Sn.iTime.value=this.backgroundTime,og.forEach((n,r)=>{n.intensity=this.lightsIntensity*1e3,n.position.x=Math.sin(e+r*10)*10,n.position.z=Math.cos(e+r*10)*10})}onNotePlay(){this.lightsIntensity=Math.min(1,this.lightsIntensity*1.1),this.backgroundTime+=.1}updateVisibility(t){Sn.iVisibility.value=t}}const Qo=2,tl=.1;class Xg{constructor(t,e){this.game=t,this.setNotes(e),this.setHitWindow(.05)}notes=[];timeTop=0;_bottomNoteIndex=0;_bottomClickableNoteIndex=0;_topClickableNoteIndex=0;_topNoteIndex=0;hitWindow=.05;setNotes(t){this.notes=t,this._bottomNoteIndex=0,this._bottomClickableNoteIndex=0,this._topClickableNoteIndex=0,this._topNoteIndex=0}update(){const t=this.game.timeNow;this.timeTop=t+Qo;const e=t+this.hitWindow,n=t-Math.min(this.hitWindow,tl),r=t-tl,s=this.notes;for(let a=Math.max(0,this._bottomNoteIndex);a<s.length;a++){const o=s[a],l=o.time;if(l<r&&(this._bottomNoteIndex=a),l<n)this._bottomClickableNoteIndex=a,this.noteFinished(o);else if(l<e)this._topClickableNoteIndex=a+1;else if(l<this.timeTop)this._topNoteIndex=a+1;else break}}getDisplayNotes(){return this.notes.slice(this._bottomNoteIndex,this._topNoteIndex)}getClickableNotes(t){return this.notes.slice(this._bottomClickableNoteIndex,this._topClickableNoteIndex).filter(n=>t==n.note)}click(t){const e=this.getClickableNotes(t);if(e.length==0)return this.onFail(t,!0),!1;const n=ag(e,this._distance);return n.status!==void 0?(this.onFail(t,!0),!1):(n.status=!0,this.onSuccess(t),!0)}noteFinished(t){t.status===void 0&&(t.status=!1,this.onFail(t.note,!1),console.warn("Missed note"))}onFail(t,e=!1){this.game.combo.onFail(),e&&this.game.visuals.finishVisuals.onHitOrMiss(!1,t)}onSuccess(t){this.game.combo.onSuccess(),this.game.visuals.finishVisuals.onHitOrMiss(!0,t)}setHitWindow(t){this.hitWindow=t,this.game.visuals.finishVisuals.setFinishSize(this.hitWindow,Qo)}_distanceS=t=>t.time-this.game.timeNow;_distance=t=>Math.abs(this._distanceS(t))}class qg{timeNow=0;timeOffset=0;combo;visuals;notes;meta;difficulty;constructor(t,e,n,r){this.meta=n,this.difficulty=r,this.combo=new yg,this.visuals=new Hg(this,e),this.notes=new Xg(this,t)}getStats(){const{hits:t,fails:e,score:n,maxCombo:r}=this.combo,s=t+e,a=s===0?0:t/s;return{score:n,hits:t,fails:e,accuracy:a,maxCombo:r}}update(t){t+=this.timeOffset;const e=t-this.timeNow;this.timeNow=t,this.notes.update(),this.visuals.update(e)}click(t){this.notes.click(t)}setTimeOffset(t){this.timeOffset=t}setHitWindow(t){this.notes.setHitWindow(t)}}const Be=document.getElementById("audioPlayer"),el=document.getElementById("hitTime"),nl=document.getElementById("timeOffset"),il=document.getElementById("visibility"),rl=document.getElementById("volume"),ec=document.getElementById("startOverlay"),Yg=document.getElementById("startCover"),Kg=document.getElementById("startTitle"),Zg=document.getElementById("startAuthor"),$g=document.getElementById("startDiff"),Jg=document.getElementById("startBpm"),jg=document.getElementById("startDuration"),Qg=document.getElementById("startNps"),t_=document.getElementById("endOverlay"),e_=document.getElementById("endScore"),n_=document.getElementById("endAccuracy"),i_=document.getElementById("endMaxCombo"),r_=document.getElementById("endHits"),s_=document.getElementById("endFails"),a_=document.getElementById("endReplay"),o_=document.getElementById("endBack");let Ae,zr=!1;async function l_(){const i=fn.get("timeOffset")??0,t=fn.get("hitTime")||.075,e=fn.get("visibility")??.25,n=fn.get("audioVolume")??.5;console.log("loaded timeOffset",i,"hitTime",t,"visibility",e),el.value=t,nl.value=i,il.value=e,rl.value=n;let[r,s]=location.hash.substring(1).split("-");r?console.log("loading song",r,"difficulty",s):(console.log("loading default song"),r="9d1b",s="3",location.hash=`#${r}-${s}`);const{audio:a,meta:o,songData:l}=await lc(r);console.log(o,l);const c=o.difficulties[+s]??o.difficulties[0];Ae=new qg(l.difficulties[s].notes,l.lightEvents,o,c),Be.src=URL.createObjectURL(a),Be.volume=n,Be.load(),Ae.setTimeOffset(i),Ae.setHitWindow(t),Ae.visuals.backgroundVisuals.updateVisibility(e),c_(),window.addEventListener("resize",Ae.visuals.resize),document.body.addEventListener("keydown",d_),ec.addEventListener("click",ic),a_.addEventListener("click",()=>location.reload()),o_.addEventListener("click",()=>{window.location.href="/midi-hero/marketplace.html"}),Be.addEventListener("ended",h_),nl.addEventListener("input",h=>{Ae.setTimeOffset(+h.target.value),fn.set("timeOffset",+h.target.value)}),el.addEventListener("input",h=>{Ae.setHitWindow(+h.target.value),fn.set("hitTime",+h.target.value)}),il.addEventListener("input",h=>{Ae.visuals.backgroundVisuals.updateVisibility(+h.target.value),fn.set("visibility",+h.target.value)}),rl.addEventListener("input",h=>{Be.volume=+h.target.value,fn.set("audioVolume",+h.target.value)}),document.addEventListener("visibilitychange",()=>{document.hidden&&Be.pause()})}function nc(){requestAnimationFrame(nc),Ae&&(document.hidden||Ae.update(Be.currentTime))}l_();nc();function c_(){const{meta:i,difficulty:t}=Ae;Yg.src=i.coverURL,Kg.textContent=i.songName,Zg.textContent=i.songAuthor;const e=t.characteristic&&t.characteristic!=="Standard"?`${t.characteristic} `:"";$g.textContent=`${e}${t.name}`,Jg.textContent=`${i.bpm} BPM`,jg.textContent=u_(i.duration),Qg.textContent=`${t.notesPerSecond.toFixed(2)} NPS`}function ic(){zr||(zr=!0,ec.classList.add("hidden"),Be.play())}function h_(){const i=Ae.getStats();e_.textContent=String(i.score),n_.textContent=`${(i.accuracy*100).toFixed(1)}%`,i_.textContent=String(i.maxCombo),r_.textContent=String(i.hits),s_.textContent=String(i.fails),t_.classList.remove("hidden")}function u_(i){const t=Math.floor(i/60),e=Math.floor(i%60);return`${t}:${e.toString().padStart(2,"0")}`}const f_={KeyS:0,KeyD:1,KeyK:2,KeyL:3};function d_(i){if(i.key==" "){zr?Be.paused?Be.play():Be.pause():ic(),i.preventDefault();return}if(!zr)return;const t=f_[i.code];t!=null&&(Ae.click(t),i.preventDefault())}
